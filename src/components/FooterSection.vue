        ...
        <div class="col-span-1 md:col-span-2">
          <div class="flex items-center space-x-3 mb-4">
            <div class="w-12 h-12 bg-white/10 backdrop-blur-sm rounded-lg flex items-center justify-center">
              <span class="text-white font-bold text-xl">KY</span>
            </div>
            <div>
              <div class="text-2xl font-display font-bold">KY EXPORT LLC</div>
              <div class="text-sm text-gray-300">International Trade Solutions</div>
            </div>
          </div>
