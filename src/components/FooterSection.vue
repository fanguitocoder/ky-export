<template>
  <footer class="bg-gradient-to-br from-gray-900 via-primary-900 to-gray-900 text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        <!-- Company Info -->
        <div class="col-span-1 md:col-span-2 text-center md:text-left">
          <router-link to="/" class="inline-block mb-4">
            <img :src="logoSrc" alt="KY EXPORT" class="h-16 w-auto" style="background-color: white;" />
          </router-link>
          <p class="text-gray-300 mb-4 max-w-md">
            {{ $t('footer.tagline') }}
          </p>
          <div class="flex space-x-4">
            <a href="https://www.instagram.com/kyexport_llc/?igsh=bWhhOHpsYTF5enB4&utm_source=qr#" target="_blank" rel="noopener noreferrer" class="text-gray-300 hover:text-white transition-colors">
        ...
        <div>
          ...
          <ul class="space-y-3 text-gray-300">
            ...
            <li class="flex items-center">
              ...
              <a :href="`mailto:${contactInfo.email}`" class="text-sm hover:text-white">{{ contactInfo.email }}</a>
            </li>
            <li class="flex items-center">
              <svg class="w-5 h-5 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
              </svg>
              <a :href="`tel:${contactInfo.phone}`" class="text-sm hover:text-white">{{ contactInfo.phone }}</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="border-t border-white/10 mt-8 pt-8 text-center text-sm text-gray-400">
        <p>&copy; {{ currentYear }} KY EXPORT LLC. All rights reserved.</p>
        <p class="mt-2">Licensed International Trade Company | Authorized Milexus Distributor</p>
      </div>
    </div>
  </footer>
</template>
